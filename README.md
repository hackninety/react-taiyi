...
- **皇极经世历**（可切换流派，**一元全跨度**）：任一起局年份给出邵雍元会运世坐标
  ...
  **祝泌**（先天六十卦序平推，未对照原文，仅供参考）两派切换并互注对照。
  ...
  太乙主盘范围（600–9999）内两盘互参，范围外单独出皇极卡并自动切换元会运世专用导出；
  公元前推算经文献锚点验证（尧甲辰=随、孔子庚戌=履）。
...
- **皇极经世历不受上述范围限制**：勾选「皇极」解锁一元全跨度（公元前 67016 — 公元 62583）。
  元会运世以年为纲、不依赖农历古历表；太乙范围外月日时卦按拟推格里历 + 天文节气取数
  （古远年份民用日期或有 ±1 日差，面板与导出均注明口径）；不勾选则维持 600–9999 默认范围
